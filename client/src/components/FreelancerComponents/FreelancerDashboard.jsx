        ...
        dispatch(myDashboard()).unwrap().then(data => {
            setTimeout(() => {
                ...
                if (data.status === 505) {
                    ...
                    // Set `order` and `complete` only if `data` is defined
                    setOrder(data?.dashboard?.ordersNumber || 0);
                    setComplete(data?.dashboard?.completedOrders || 0);
                }
            }, 1000);
                                ...
                                <div className="stats">
                                    <div className="card">
                                        <div className="info">
                                            ...
                                            <div className="body-stat">{data?.dashboard?.revenues} $</div>
                                        </div>
                                        <div className="logo">
                                    ...
                                    <div className="card">
                                        <div className="info">
                                            <div className="title">Total Pending Payment</div>
                                            <div className="body-stat">{totalPendingPayment} $</div>
                                        </div>
                                        <div className="logo">
                                            <img src={usd} alt="Star icon" />
                                        </div>
                                    ...
                                    <div className="card">
                                        <div className="info">
                                            ...
                                            <div className="body-stat">{data?.dashboard?.ordersNumber}</div>
                                        </div>
                                        <div className="logo">
                                    ...
                                    <div className="card">
                                        <div className="info">
                                            ...
                                            <div className="body-stat">{data?.dashboard?.completedOrders}</div>
                                        </div>
                                        <div className="logo">
